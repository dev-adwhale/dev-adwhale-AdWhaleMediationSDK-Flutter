...
public class AdWhaleAdsViewFactory extends PlatformViewFactory {
    @NonNull
    ...
    AdWhaleAdsViewFactory(@NonNull AdInstanceManager manager) {
    ...
    private static PlatformView getErrorView(@NonNull final Context context, int adId) {
        ...
        if (BuildConfig.DEBUG) {
            ...
            Log.e(AdWhaleAdsViewFactory.class.getSimpleName(), message);
